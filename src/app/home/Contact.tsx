            ...
            <div className="container">
                ...
                <div className="columns is-one-third contacts">
                    <div className="column general-inquiries">
                        ...
                        <p>
                            Tel: <span className="orange-text">+971 56 439 8599</span><br/>
                    ...
                    <div className="column social-media">
                        ...
                        <p>
                            <a href="https://www.facebook.com/salazar.gents.salon">Facebook</a><br/>
                            <a href="https://www.instagram.com/salazargentssalon">Instagram</a><br/>
